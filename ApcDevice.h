...
public:
	...
	static Matrix GenRotationMatrix(const Vector3& rotAngle);
	...
	static Matrix GenRotationXMatrix(float angle);
	static Matrix GenRotationYMatrix(float angle);
	static Matrix GenRotationZMatrix(float angle);
private:
